...
const Index = () => {
  ...
  const getNasaData = async () => {
    const res = await fetch(`https://images-api.nasa.gov/search?q=${currentSearch}&page=${currentPage}`);
  ...
  return (
    <div>
      ...
      <input id="searchInput" type='text' onChange={onChangeCurrentSearch} value={currentSearch}></input>
      <button id='searchButton' onClick={searchNasaData}>search</button>
      <br></br>
      <br></br>
